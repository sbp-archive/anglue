define(['exports', './behaviors/behavior', './behaviors/event-emitter', './behaviors/entity-store', './behaviors/filterable-store', './behaviors/searchable-component', './behaviors/sortable-store', './behaviors/sortable-component', './behaviors/paginatable-store', './behaviors/paginatable-component', './behaviors/transformable'], function (exports, _behaviorsBehavior, _behaviorsEventEmitter, _behaviorsEntityStore, _behaviorsFilterableStore, _behaviorsSearchableComponent, _behaviorsSortableStore, _behaviorsSortableComponent, _behaviorsPaginatableStore, _behaviorsPaginatableComponent, _behaviorsTransformable) {
  'use strict';
