System.register(["angular", "./annotation"], function (_export) {
    ...
    var angular, Annotation, _applyConstructor, _toConsumableArray, _prototypeProperties, _get, _inherits, _classCallCheck, Store;
    return {
        ...
        execute: function () {
            ...
            Store = _export("Store", (function (Annotation) {
                function Store() {
